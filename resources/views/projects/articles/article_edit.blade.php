...
@section('content')
    ...
    {!! Form::open(['url' => 'projects/' . Session::get('currentProject')['id'] . '/articles/' . $article->id, 'method' => 'put']) !!}
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    {!! Form::open(['url' => 'projects/' . Session::get('currentProject')['id'] . '/articles/' . $article->id, 'method' => 'delete']) !!}
                    {{ Form::submit('Delete') }}
                    {!! Form::close() !!}
                </div>
            </div>
